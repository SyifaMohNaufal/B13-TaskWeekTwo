      ...
      var Swatches = (function (_Palette) {
        ...
        _createClass(Swatches, [{
          ...
          value: function load () {
            ...
            var swatchContainer = this.element.find('.colorpicker-swatches--inner')
            var isAliased = this.options.namesAsValues === true && !Array.isArray(this.colors)
   ...
   */
     ...
     */
          ...
          value: function update () {
            ...
            var slider = vertical ? this.options.sliders : this.options.slidersHorz

            var saturationGuide = this.picker.find('.colorpicker-saturation .colorpicker-guide')
            var hueGuide = this.picker.find('.colorpicker-hue .colorpicker-guide')
            var alphaGuide = this.picker.find('.colorpicker-alpha .colorpicker-guide')
