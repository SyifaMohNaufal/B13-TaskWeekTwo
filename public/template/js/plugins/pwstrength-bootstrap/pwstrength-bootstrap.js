...
// Source: src/i18n.js
  ...
  (function ($, rulesEngine) {
    ...
    validation.wordMinLength = function (options, word, score) {
      ...
      var lenScore = Math.pow(wordlen, options.rules.raisePower)
    ...
    rulesEngine.executeRules = function (options, word) {
      ...
      $.each(options.rules.activated, function (rule, active) {
        if (active) {
          ...
          var funct = rulesEngine.validation[rule]
          var result
          var errorMessage
  ...
  defaultOptions.ui.popoverError = function (options) {
    ...
    var errorsTitle = options.i18n.t('errorList')
    var message = '<div>' + errorsTitle + "<ul class='error-list' style='margin-bottom: 0;'>"
  ...
  (function ($, ui) {
    ...
    ui.percentage = function (options, score, maximun) {
      ...
      var min = options.ui.progressBarMinPercentage
  ...
  (function ($, methods) {
    ...
    methods.init = function (settings) {
      this.each(function (idx, el) {
        ...
        var localOptions = $.extend(true, clonedDefaults, settings)
        var $el = $(el)
    ...
    methods.destroy = function () {
      this.each(function (idx, el) {
        var $el = $(el)
        var options = $el.data('pwstrength-bootstrap')
        var elements = ui.getUIElements(options, $el)
