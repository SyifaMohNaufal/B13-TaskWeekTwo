...
(function (factory) {
  ...
  Datepicker.prototype = {
    ...
    _trigger: function (event, altdate) {
      ...
      var local_date = this._utc_to_local(date)
      ...
      while (prevMonth.valueOf() < nextMonth) {
        ...
        if (weekDay === this.o.weekStart) {
          ...
          if (this.o.calendarWeeks) {
            ...
            var yth = new Date(Number(yth = UTCDate(th.getUTCFullYear(), 0, 1)) + (7 + 4 - yth.getUTCDay()) % 7 * 864e5)
  ...
  DateRangePicker.prototype = {
    ...
    dateUpdated: function (e) {
      ...
      var keep_empty_values = this.keepEmptyValues
  ...
  var datepickerPlugin = function (option) {
    ...
    this.each(function () {
      ...
      if (!data) {
        ...
        var locopts = opts_from_locale(xopts.language)
  ...
  var DPGlobal = {
    ...
    parseDate: function (date, format, language, assumeNearby) {
      ...
      var parts; var part; var dir; var i; var fn
