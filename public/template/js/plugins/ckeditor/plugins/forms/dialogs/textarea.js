...
CKEDITOR.dialog.add('textarea', function (b) {
  return {
    ...
    minWidth: 350,
    minHeight: 220,
    onShow: function () { delete this.textarea; var a = this.getParentEditor().getSelection().getSelectedElement(); a && a.getName() == 'textarea' && (this.textarea = a, this.setupContent(a)) },
    onOk: function () { var a; var b = this.textarea; var c = !b; c && (a = this.getParentEditor(), b = a.document.createElement('textarea')); this.commitContent(b); c && a.insertElement(b) },
    contents: [{
      id: 'info',
      ...
      elements: [{ id: '_cke_saved_name', type: 'text', label: b.lang.common.name, default: '', accessKey: 'N', setup: function (a) { this.setValue(a.data('cke-saved-name') || a.getAttribute('name') || '') }, commit: function (a) { this.getValue() ? a.data('cke-saved-name', this.getValue()) : (a.data('cke-saved-name', !1), a.removeAttribute('name')) } }, {
        ...
        children: [{
          ...
          setup: function (a) { a = a.hasAttribute('cols') && a.getAttribute('cols'); this.setValue(a || '') },
          ...
          style: 'width:50px',
          validate: CKEDITOR.dialog.validate.integer(b.lang.common.validateNumberFailed),
          setup: function (a) { a = a.hasAttribute('rows') && a.getAttribute('rows'); this.setValue(a || '') },
          commit: function (a) {
