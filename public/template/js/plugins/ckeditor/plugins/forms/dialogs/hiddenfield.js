...
CKEDITOR.dialog.add('hiddenfield', function (d) {
  return {
    ...
    minWidth: 350,
    minHeight: 110,
    onShow: function () { delete this.hiddenField; var a = this.getParentEditor(); var b = a.getSelection(); var c = b.getSelectedElement(); c && c.data('cke-real-element-type') && c.data('cke-real-element-type') == 'hiddenfield' && (this.hiddenField = c, c = a.restoreRealElement(this.hiddenField), this.setupContent(c), b.selectElement(this.hiddenField)) },
    onOk: function () {
      var a = this.getValueOf('info', '_cke_saved_name')
      var b = this.getParentEditor(); var a = CKEDITOR.env.ie && CKEDITOR.document.$.documentMode < 8 ? b.document.createElement('\x3cinput name\x3d"' + CKEDITOR.tools.htmlEncode(a) + '"\x3e') : b.document.createElement('input'); a.setAttribute('type', 'hidden'); this.commitContent(a); a = b.createFakeElement(a, 'cke_hidden', 'hiddenfield'); this.hiddenField ? (a.replace(this.hiddenField), b.getSelection().selectElement(a)) : b.insertElement(a); return !0
    },
    contents: [{
      id: 'info',
