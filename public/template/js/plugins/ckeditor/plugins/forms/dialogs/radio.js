...
CKEDITOR.dialog.add('radio', function (c) {
  return {
    ...
    minWidth: 350,
    minHeight: 140,
    onShow: function () { delete this.radioButton; var a = this.getParentEditor().getSelection().getSelectedElement(); a && a.getName() == 'input' && a.getAttribute('type') == 'radio' && (this.radioButton = a, this.setupContent(a)) },
    onOk: function () { var a; var b = this.radioButton; b || (a = this.getParentEditor(), b = a.document.createElement('input'), b.setAttribute('type', 'radio'), a.insertElement(b)); this.commitContent({ element: b }) },
    contents: [{
      id: 'info',
      label: c.lang.forms.checkboxAndRadio.radioTitle,
      title: c.lang.forms.checkboxAndRadio.radioTitle,
      elements: [{ id: 'name', type: 'text', label: c.lang.common.name, default: '', accessKey: 'N', setup: function (a) { this.setValue(a.data('cke-saved-name') || a.getAttribute('name') || '') }, commit: function (a) { a = a.element; this.getValue() ? a.data('cke-saved-name', this.getValue()) : (a.data('cke-saved-name', !1), a.removeAttribute('name')) } }, {
        id: 'value',
        type: 'text',
        ...
        commit: function (a) {
          var b = a.element; if (CKEDITOR.env.ie) {
            var d = b.getAttribute('checked'); var e = !!this.getValue(); d != e && (d = CKEDITOR.dom.element.createFromHtml('\x3cinput type\x3d"radio"' +
