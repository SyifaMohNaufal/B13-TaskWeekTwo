  ...
  CKEDITOR.plugins.add('selectall', {
    ...
    init: function (b) {
      b.addCommand('selectAll', {
        ...
        exec: function (a) {
          var b = a.editable(); if (b.is('textarea')) {
            a = b.$, CKEDITOR.env.ie && a.createTextRange ? a.createTextRange().execCommand('SelectAll')
              : (a.selectionStart = 0, a.selectionEnd = a.value.length), a.focus()
          } else { if (b.is('body'))a.document.$.execCommand('SelectAll', !1, null); else { var c = a.createRange(); c.selectNodeContents(b); c.select() }a.forceNextSelectionCheck(); a.selectionChange() }
        },
        canUndo: !1
