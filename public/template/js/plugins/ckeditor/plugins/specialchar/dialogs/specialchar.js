...
CKEDITOR.dialog.add('specialchar', function (k) {
  var e; var n = k.lang.specialchar; var m = function (c) { var b; c = c.data ? c.data.getTarget() : new CKEDITOR.dom.element(c); c.getName() == 'a' && (b = c.getChild(0).getHtml()) && (c.removeClass('cke_light_background'), e.hide(), c = k.document.createElement('span'), c.setHtml(b), k.insertText(c.getText())) }; var p = CKEDITOR.tools.addFunction(m); var l; var g = function (c, b) {
    ...
    l = void 0)
  }; var q = CKEDITOR.tools.addFunction(function (c) {
    c = new CKEDITOR.dom.event(c); var b = c.getTarget(); var a; a = c.getKeystroke(); var f = k.lang.dir == 'rtl'; switch (a) {
