...
(function () {
  CKEDITOR.plugins.add('placeholder', {
    ...
    icons: 'placeholder',
    hidpi: !0,
    onLoad: function () { CKEDITOR.addCss('.cke_placeholder{background-color:#ff0}') },
    init: function (a) {
