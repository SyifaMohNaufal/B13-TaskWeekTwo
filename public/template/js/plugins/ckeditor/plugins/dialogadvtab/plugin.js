...
''; a.length && (b += '[' + a.join(',') + ']'); c.classes && (b += '(*)'); c.styles && (b += '{*}'); return b
    ...
    createAdvancedTab: function (c, a, b) {
      a || (a = k); var d = c.lang.common; var h = { id: 'advanced', label: d.advancedTab, title: d.advancedTab, elements: [{ type: 'vbox', padding: 1, children: [] }] }; var e = []; if (a.id || a.dir) {
...
a + '\\s*:\\s*([^;]*)', 'i')); return b ? b[1] : c
          ...
          updateStyle: function (a, b) { var d = this.getValue(); var e = c.document.createElement('span'); e.setAttribute('style', d); e.setStyle(a, b); d = CKEDITOR.tools.normalizeCssText(e.getAttribute('style')); this.setValue(d, 1) },
          setup: f,
          commit: g
