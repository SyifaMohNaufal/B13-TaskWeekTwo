...
(function () {
  function d (c, d) { var b; try { b = c.getSelection().getRanges()[0] } catch (f) { return null }b.shrink(CKEDITOR.SHRINK_TEXT); return c.elementPath(b.getCommonAncestor()).contains(d, 1) } function e (c, e) {
    var b = c.lang.liststyle; if (e == 'bulletedListStyle') {
      return {
...
a.getStyle('list-style-type') || g[a.getAttribute('type')] || a.getAttribute('type') || ''; this.setValue(a)
        ...
        onShow: function () { var a = this.getParentEditor(); (a = d(a, 'ul')) && this.setupContent(a) },
        onOk: function () { var a = this.getParentEditor(); (a = d(a, 'ul')) && this.commitContent(a) }
      }
    } if (e == 'numberedListStyle') {
        ...
        contents: [{
          ...
          elements: [{
            ...
            children: [{
              ...
              setup: function (a) { a = a.getFirst(f).getAttribute('value') || a.getAttribute('start') || 1; this.setValue(a) },
              commit: function (a) {
                var b = a.getFirst(f); var c = b.getAttribute('value') || a.getAttribute('start') ||
1; a.getFirst(f).removeAttribute('value'); var d = parseInt(this.getValue(), 10); isNaN(d) ? a.removeAttribute('start') : a.setAttribute('start', d); a = b; b = c; for (d = isNaN(d) ? 1 : d; (a = a.getNext(f)) && b++;)a.getAttribute('value') == b && a.setAttribute('value', d + b - c)
              ...
              style: 'width: 100%;',
              items: h,
              setup: function (a) { a = a.getStyle('list-style-type') || g[a.getAttribute('type')] || a.getAttribute('type') || ''; this.setValue(a) },
              commit: function (a) {
        ...
        onShow: function () { var a = this.getParentEditor(); (a = d(a, 'ol')) && this.setupContent(a) },
        onOk: function () { var a = this.getParentEditor(); (a = d(a, 'ol')) && this.commitContent(a) }
      }
    }
  } var f = function (c) { return c.type == CKEDITOR.NODE_ELEMENT && c.is('li') }; var g = { a: 'lower-alpha', A: 'upper-alpha', i: 'lower-roman', I: 'upper-roman', 1: 'decimal', disc: 'disc', circle: 'circle', square: 'square' }; CKEDITOR.dialog.add('numberedListStyle', function (c) { return e(c, 'numberedListStyle') }); CKEDITOR.dialog.add('bulletedListStyle',
