...
CKEDITOR.dialog.add('mathjax', function (d) {
  var c; var b = d.lang.mathjax; return {
    title: b.title,
    minWidth: 350,
    minHeight: 100,
    contents: [{
...
CKEDITOR.plugins.mathjax.fixSrc + '"\x3e\x3c/iframe\x3e\x3c/div\x3e',
        onLoad: function () { var a = CKEDITOR.document.getById(this.domId).getChild(0); c = new CKEDITOR.plugins.mathjax.frameWrapper(a, d) },
