...
a.elementId + '\x3c/strong\x3e : ' + b.id + '\x3c/li\x3e'); c += '\x3cli\x3e\x3cstrong\x3e' + a.elementType + '\x3c/strong\x3e : ' + l + '\x3c/li\x3e'; return c + '\x3c/ul\x3e'
  } function m (d, c, b, f, l, g) { var e = c.getDocumentPosition(); var h = { 'z-index': CKEDITOR.dialog._.currentZIndex + 10, top: e.y + c.getSize('height') + 'px' }; a.setHtml(d(b, f, l, g)); a.show(); b.lang.dir == 'rtl' ? (d = CKEDITOR.document.getWindow().getViewPaneSize(), h.right = d.width - e.x - c.getSize('width') + 'px') : h.left = e.x + 'px'; a.setStyles(h) } var a; CKEDITOR.on('reset', function () {
    a &&
a.remove(); a = null
