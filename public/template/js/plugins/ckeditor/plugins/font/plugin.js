...
(function () {
  function p (b, f, e, d, r, p, t, x) {
    var y = b.config; var u = new CKEDITOR.style(t); var g = r.split(';'); r = []; for (var k = {}, l = 0; l < g.length; l++) { var m = g[l]; if (m) { var m = m.split('/'); var w = {}; var q = g[l] = m[0]; w[e] = r[l] = m[1] || q; k[q] = new CKEDITOR.style(t, w); k[q]._.definition.name = q } else g.splice(l--, 1) }b.ui.addRichCombo(f, {
      label: d.label,
      title: d.panelTitle,
      toolbar: 'styles,' + x,
      ...
      allowedContent: u,
      requiredContent: u,
      contentTransformations: t.element === 'span' ? [[{
        element: 'font',
        check: 'span',
        left: function (a) {
...
!!a.attributes.align || !!a.attributes.face
      ...
      init: function () { var a; a = '(' + b.lang.common.optionDefault + ')'; this.startGroup(d.panelTitle); this.add(this.defaultValue, a, a); for (var c = 0; c < g.length; c++)a = g[c], this.add(a, k[a].buildPreview(), a) },
      onClick: function (a) {
        b.focus(); b.fire('saveSnapshot'); var c = this.getValue(); var f = k[a]; var e; var n; var h; var d; var g; if (c && a != c) {
