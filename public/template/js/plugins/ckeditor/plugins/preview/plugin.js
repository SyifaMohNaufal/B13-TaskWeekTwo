...
(function () {
  var h; var k = {
    ...
    readOnly: 1,
    exec: function (a) {
      var g; var b = a.config; var f = b.baseHref ? '\x3cbase href\x3d"' + b.baseHref + '"/\x3e' : ''; if (b.fullPage)g = a.getData().replace(/<head>/, '$\x26' + f).replace(/[^>]*(?=<\/title>)/, '$\x26 \x26mdash; ' + a.lang.preview.preview); else {
...
'\x3chtml dir\x3d"' + a.config.contentsLangDirection + '"\x3e\x3chead\x3e' + f + '\x3ctitle\x3e' + a.lang.preview.preview + '\x3c/title\x3e' + CKEDITOR.tools.buildStyleHtml(a.config.contentsCss) + '\x3c/head\x3e' + b + a.getData() + '\x3c/body\x3e\x3c/html\x3e'
      }f = 640; b = 420; d = 80; try { var c = window.screen; var f = Math.round(0.8 * c.width); var b = Math.round(0.7 * c.height); var d = Math.round(0.1 * c.width) } catch (k) {} if (!1 === a.fire('contentPreview', a = { dataValue: g })) return !1; var c = ''; var e; CKEDITOR.env.ie && (window._cke_htmlToLoad = a.dataValue, e = 'javascript:void( (function(){document.open();' +
