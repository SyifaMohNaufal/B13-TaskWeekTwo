...
CKEDITOR.skin.chameleon = (function () {
  var b = (function () { return function (b, e) { for (var a = b.match(/[^#]./g), c = 0; c < 3; c++) { var f = c; var d; d = parseInt(a[c], 16); d = ('0' + (e < 0 ? 0 | d * (1 + e) : 0 | d + (255 - d) * e).toString(16)).slice(-2); a[f] = d } return '#' + a.join('') } }()); var c = (function () {
